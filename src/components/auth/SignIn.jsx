    ...
    return (
        <main className="w-full h-screen flex flex-col items-center justify-center px-4">
            <div className="max-w-sm w-full text-gray-600 space-y-5">
                ...
                <Link to="/LandingPage"><img src="/images/logoTinclinadaBlack.png"  width={150} className="mx-auto" /></Link>
                    <div className="mt-5">
                ...
                >
                    ...
                    <div className="flex items-center justify-between text-sm">
                        ...
                        <Link to="/forgot-password" className="text-center text-indigo-600 hover:text-indigo-500">¿Has olvidado tu contraseña?</Link>
                    </div>
                    <button
                        onClick={handleLogin} // Usa la función handleLogin
                ...
                <p className="text-center">¿No tienes una cuenta? <Link to="/signUp" className="font-medium text-indigo-600 hover:text-indigo-500">Registrate</Link></p>
            </div>
        </main>
    );
};

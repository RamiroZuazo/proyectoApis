export default () => {
    ...
    return (
        <footer className="text-gray-500 bg-gray-900 px-4 py-5 w-full">
            <div className="max-w-lg sm:mx-auto sm:text-center">
                <img src="/images/logoTinclinada.png"  className="w-32 sm:mx-auto" />
                <p className="leading-relaxed mt-2 text-[15px]">
                Ticketify transforma la forma en que gestionas gastos compartidos. Desde pequeños grupos hasta grandes eventos, te ayudamos a mantener las finanzas organizadas y las amistades intactas.                </p>
            </div>
            ...
            <div className="mt-8 items-center justify-between sm:flex">
                <div className="mt-4 sm:mt-0">
                    &copy; 2024 Ticketify All rights reserved.
                </div>
